...
<head>
    ...
    <style>
        body { font-family: 'Inter', sans-serif; background-color: #0A0C10; color: #fff; }
...
<a href="/admin/users" class="flex items-center gap-3 px-4 py-3 rounded-xl bg-purple-500/10 text-purple-400 border border-purple-500/20 text-sm font-bold">
                        ...
                        <tbody class="divide-y divide-white/5">
                            @forelse($users as $u)
                                ...
                                <tr id="details-{{ $u->id }}" class="hidden bg-[#0A0C10]/50">
                                    <td colspan="8" class="px-6 border-t border-white/5">
                                        <div id="content-{{ $u->id }}" class="py-6 grid grid-cols-1 md:grid-cols-3 gap-6 transition-all duration-[700ms] ease-in-out opacity-0 max-h-0 overflow-hidden transform -translate-y-4">
                            ...
                            @empty
                                <tr>
                                    <td colspan="8" class="px-6 py-16 text-center text-gray-600">
                                        <svg class="w-16 h-16 mx-auto mb-3 opacity-50" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path d="M15 7C15 8.65685 13.6569 10 12 10C10.3431 10 9 8.65685 9 7C9 5.34315 10.3431 4 12 4C13.6569 4 15 5.34315 15 7Z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M5 21C5 17.134 8.13401 14 12 14C15.866 14 19 17.134 19 21" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M17 10C18.1046 10 19 9.10457 19 8C19 6.89543 18.1046 6 17 6" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M21 19C21 16.5147 19.389 14.4061 17.1355 13.6279" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>
            ...
            if (tr.classList.contains('hidden')) {
                ...
                document.querySelectorAll('tr[id^="details-"]').forEach(otherTr => {
                    if (otherTr.id !== 'details-' + id) {
                        setTimeout(() => otherTr.classList.add('hidden'), 700);
                    }
                });
