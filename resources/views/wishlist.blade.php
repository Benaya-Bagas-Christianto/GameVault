...
<body class="flex h-screen overflow-hidden antialiased selection:bg-purple-500 selection:text-white" style="background-color: #0A0C10 !important;">
    ...
    <div class="flex-1 flex flex-col h-full overflow-hidden relative">
        ...
        <div class="flex-1 overflow-y-auto hide-scrollbar flex flex-col xl:flex-row" style="background-color: #0A0C10 !important;">
            <main class="flex-1 p-6 lg:p-8 flex flex-col gap-6">
